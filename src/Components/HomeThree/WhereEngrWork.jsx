...
function WhereEngrWork() {
  return (
    <section
      className="work-area-two work-bg"
      style={{
        backgroundImage: `url(${require("../../assets/img/bg/work_bg.jpg")})`,
      }}
    >
        ...
        <div className="row">
          <div className="col-lg-12">
            <div
              ...
              style={{
                backgroundImage: `url(${require("../../assets/img/images/h3_work_img.jpg")})`,
              }}
            >
